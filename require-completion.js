  function RequireCompletion (IVEditor, interaction) {
	    ...
	    var t = IVMEDIAEditor.InteractiveVideo.t;
	    ...
	    enableRetryDisabledMsg.className = [
	      'ivmediaeditor-field-description',
	      'ivmediaeditor-enable-retry-disabled-msg',
	      'ivmedia-hide'
	    ].join(' ');
	    ...
	    pauseDisabledMsg.className = [
	      'ivmediaeditor-field-description',
	      'ivmediaeditor-pause-disabled-msg',
	      'ivmedia-hide'
	    ].join(' ');
	    ...
	    conflictingTimeMsg.className = [
	      'ivmediaeditor-field-description',
	      'ivmediaeditor-conflicting-time-msg',
	      'ivmedia-hide'
	    ].join(' ');
	    ...
	    function handleConflictingInteractions(interaction, otherInteractions) {
	      ...
	      conflictingTimeMsg.classList.toggle('ivmedia-hide', !conflictingInteractions.length);
	    }
	    ...
	    function toggleDuration(isChecked) {
	      if (!isChecked) {
	        conflictingTimeMsg.classList.add('ivmedia-hide');
	        return;
	      }
	    ...
	    function togglePause(isChecked) {
	      ...
	      interactionFields.pause.$item.toggleClass('ivmedia-has-disabled-msg', isChecked);
	      pauseDisabledMsg.classList.toggle('ivmedia-hide', !isChecked);
	    }
	    ...
	    function toggleRetry(isChecked) {
	      if (enableRetry) {
	        ...
	        enableRetryDisabledMsg.classList.toggle('ivmedia-hide', !isChecked);
	      }
	    }
